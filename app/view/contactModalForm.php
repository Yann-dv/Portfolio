			...
			<div class="gridForm">
				<div class="inputCheck">
					<div class="userProfile">
						<div class="form-group input-group">
							...
							<input id="userName" type="text" name="userName" class="form-control" aria-label="nom et prénom" placeholder="Nom / Prénom" autocomplete="off" min="2" max-length="50" required>
						</div>
								...
								<div class="i-checks">
									<div class="iradio_minimal-grey"><input type="radio" id="idRadioP" name="typeUserDevis" value="1" checked="checked">
										...
										<div id="blocCompagny" class="form-group input-group">
											...
											<input id="compagny" type="text" name="compagny" class="form-control" placeholder="Société / Association :" autocomplete="off" min="2" max-length="50"> 
										</div>
									</div>
								</div>
							</div>
				...
				<div class="userContact">
					...
					<div class="form-group input-group">
						...
						autocomplete="off" min="2" max-length="15"> 
					...
					<div class="form-group input-group">
						...
						<input id="userUrl" type="url" name="userUrl" class="form-control" placeholder="https://my_project_url.com" aria-label="lien vers votre projet"
       					pattern="https://.*" size="30" autocomplete="off" min="2" max-length="600">
					</div>
				</div>
			</div>
