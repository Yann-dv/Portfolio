			...
			<div class="gridForm">
				<div class="inputCheck">
					<div class="userProfile">
						<div class="form-group input-group">
							...
							<input id="userName" type="text" name="userName" class="form-control" aria-label="nom et prénom" placeholder="Nom / Prénom" autocomplete="off" minlength="2" max-length="50" required>
						</div>
								...
								<div class="i-checks">
									<div class="iradio_minimal-grey"><input type="radio" id="idRadioP" name="typeUserDevis" value="1" checked="checked">
										...
										<div id="blocCompagny" class="form-group input-group">
											...
											<input id="compagny" type="text" name="compagny" class="form-control" placeholder="Société / Association :" autocomplete="off" minlength="2" max-length="50"> 
										</div>
									</div>
								</div>
							</div>
				...
				<div class="userContact">
					<div class="form-group input-group">
						...
						<input type="email" name="email" id="email" aria-label="email" class="form-control" placeholder="E-mail" autocomplete="off" minlength="2" required> 
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></span>
						<input id="phone" type="tel" name="tel" class="form-control" placeholder="Téléphone" aria-label="téléphone"
						pattern="^(?:(?:\+|00)33[\s.-]{0,3}(?:\(0\)[\s.-]{0,3})?|0)[1-9](?:(?:[\s.-]?\d{2}){4}|\d{2}(?:[\s.-]?\d{3}){2})$"
						autocomplete="off" minlength="2" max-length="15"> 
					...
					<div class="form-group input-group">
						...
						<input id="userUrl" type="url" name="userUrl" class="form-control" placeholder="https://my_project_url.com" aria-label="lien vers votre projet"
       					pattern="https://.*" size="30" autocomplete="off" minlength="2" max-length="600">
					</div>
				</div>
			</div>
				...
				<div class="projectCheck">
					...
					<div class="form-group input-group projectDescription">
						<textarea id="message" rows="5" name="message" minlengt="2" max-length="600" aria-label="description de votre projet"
