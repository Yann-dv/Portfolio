	    ...
	    <fieldset>
			<div class="inputCheck">
	            ...
	            <div class="form-group input-group">
					<div class="inputCheck">
						<div class="i-checks">
    						<div class="iradio_minimal-grey checked"><input type="radio" id="idRadioP" name="typeUserDevis" value="1" checked="">
							<label id="idRadioP_label" for="idRadioP" class="bold">Particulier</label>
						</div>
					</div>
					<div class="inputCheck">
						<div class="i-checks">
							<div class="iradio_minimal-grey"><input type="radio" id="idRadioA" name="typeUserDevis" value="2">
							<label id="idRadioA_label" for="idRadioA">Association</label>
						</div>
					</div>								
					<div class="inputCheck">
						<div class="i-checks">
							<div class="iradio_minimal-grey"><input type="radio" id="idRadioS" name="typeUserDevis" value="3">
	            ...
	            <div class="form-group input-group select-input-group">
	                <span class="jcf-select jcf-unselectable"><select name="typeProjetDevis" class="jcf-reset-appearance">
